...
class quizQuestionActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun defaultOptionView(){
        ...
        for(options in option){
            ...
            options.background = ContextCompat.getDrawable(
                this,
                R.drawable.default_option_border_ig
            )
        }
    ...
    private fun selectedOptionView(tv:TextView,selectedOptionNum:Int){
        ...
        selCurrPos = selectedOptionNum

        tv.setTextColor(Color.parseColor("#363A43"))
        tv.setTypeface(tv.typeface,Typeface.BOLD)
        tv.background = ContextCompat.getDrawable(
            this,
            R.drawable.selected_tv_border_bg
        )
                ...
                if(selCurrPos==0){
                    ...
                    when{
                        currPos<=questionList!!.size->{
                            ...
                            intent.putExtra(Constants.CORRECT_ANSWER,mcurrectAnswers)
                    ...
                    val question = questionList?.get(currPos-1)
                    if(question!!.correctAns!= selCurrPos){
                        answerView(selCurrPos,R.drawable.wrong_option_border_ig)
                    }
                    else{
                        mcurrectAnswers++
                    }
                    answerView(question.correctAns,R.drawable.correct_option_border_ig)
                }
